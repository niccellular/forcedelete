...
public class ForceDeleteLifecycle implements Lifecycle {
    ...
    public ForceDeleteLifecycle(Context ctx) {
    ...
    public void onCreate(final Activity arg0,
        ...
        ForceDeleteLifecycle.this.overlays
                .add(new ForceDeleteMapComponent());

        // create components
        Iterator<MapComponent> iter = ForceDeleteLifecycle.this.overlays
                .iterator();
        MapComponent c;
        while (iter.hasNext()) {
            c = iter.next();
            try {
                c.onCreate(ForceDeleteLifecycle.this.pluginContext,
                        arg0.getIntent(),
                        ForceDeleteLifecycle.this.mapView);
            } catch (Exception e) {
                Log.w(TAG,
